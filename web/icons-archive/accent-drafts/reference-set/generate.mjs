...
const ICONS = [
  ...
  { key:'triangle', label:'삼각형', note:'각 꼭짓점 빨간 점',
    inner:`<path d="M5 5 L5 19 L19 19 Z"/>${dot(5,5)}${dot(5,19)}${dot(19,19)}` },
  ...
  { key:'triangle-diag', label:'삼각형 B', note:'각 꼭짓점 빨간 점',
    inner:`<path d="M5 19 L19 19 L19 5 Z"/>${dot(5,19)}${dot(19,19)}${dot(19,5)}` },
  { key:'quad', label:'사변형/트래피조이드', note:'각 꼭짓점 빨간 점',
    inner:`<path d="M4 18 L7 7 L19 5 L20 16 Z"/>${dot(4,18)}${dot(7,7)}${dot(19,5)}${dot(20,16)}` },
