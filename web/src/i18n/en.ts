...
export const EN: Record<string, string> = {
  ...
  '치수 라벨 표시/숨기기': 'Show/Hide Dimension Labels',
  '축 표시': 'Show Axes',
  ...
  '컴포넌트를 배치했습니다 — 이동 도구로 옮기세요': 'Component placed — use the Move tool to position it',
  '컴포넌트 배치에 실패했습니다': 'Could not place the component',
  ...
  '⇕ 작업 평면 띄우기 · 법선 방향': '⇕ Offset work plane · along its normal',
  '⟲ 작업 평면 기울이기': '⟲ Tilt work plane',
  '작업 평면 띄우기 (법선 방향)': 'Offset work plane (along its normal)',
  '작업 평면 기울이기': 'Tilt work plane',
  '평면을 법선 방향으로 이동할 거리 (mm, 음수 가능)':
    'Distance to move the plane along its normal (mm, may be negative)',
  '평면을 기울일 각도 (도, 음수 가능)': 'Angle to tilt the plane (degrees, may be negative)',
  '평면을 {d} mm 이동했습니다': 'Moved the plane {d} mm',
  '평면을 {a}° 기울였습니다': 'Tilted the plane {a}°',
  ...
  '홈 뷰': 'Home view',
  '그리드 토글': 'Toggle grid',
  '치수 라벨 토글': 'Toggle dimension labels',
  '치수 라벨 표시': 'Dimension labels shown',
  '치수 라벨 숨김': 'Dimension labels hidden',
  '축 표시 토글': 'Toggle axes',
  '축': 'Axes',
  'SSAO 토글': 'Toggle SSAO',
  '그림자 PRO': 'Shadows PRO',
  ...
  'IFC 내보내기': 'Export IFC',
  'DXF 내보내기 완료': 'DXF export complete',
  'OBJ 내보내기 완료': 'OBJ export complete',
  'glTF 내보내기 완료': 'glTF export complete',
  'STL 내보내기 완료': 'STL export complete',
  ...
  '곡면을 나누려면 반대쪽 가장자리까지 3번 이상 클릭하세요.':
    'To split a curved face, click three or more times, out to the far edge.',
  '곡면이 나뉘지 않았습니다 — 선이 반대쪽 가장자리까지 닿아야 합니다.':
    'The face was not split — the line has to reach the far edge.',
  '곡면이 나뉘었습니다.': 'The face is split.',
  ...
  'Slice: 선택된 면에 소속 볼륨이 없습니다': 'Slice: the selected face does not belong to a volume (XIA)',
  'Slice: 한 번에 하나의 볼륨만 자를 수 있습니다 — 단일 솔리드의 면을 선택하세요': 'Slice: one volume at a time — select faces from a single solid',
  'Slice: {label}에 면이 없습니다': 'Slice: {label} has no faces',
  ...
  ' — 아래쪽 새 볼륨 (#{id})': ' — bottom is a new volume (#{id})',
  ...
  'Slice 완료 — 위쪽은 원본 볼륨에 유지, 아래쪽은 새 볼륨 (#{id})': 'Slice done — the top stays with the original volume, the bottom is a new one (#{id})',
