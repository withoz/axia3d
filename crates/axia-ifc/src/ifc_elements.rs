    ...
    fn two_wall_model() -> String {
        ...
        emit_ifc_model(
            ...
            &[
                ...
                IfcElement { name: "Wall B".into(), material_name: None, material_rgba: None, kind: crate::IfcElementKind::Wall, face_ids: b },
            ],
            0.001,
            "House",
        )
...
";
    ...
    fn non_ascii_material_name_round_trips() {
        ...
        let ifc = emit_ifc_model(
            ...
            &[IfcElement {
                name: "벽체".into(),
                material_name: Some("강철".into()), material_rgba: None,
